...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(103) ], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
	"use strict";
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var jQuery = __webpack_require__(98);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./node_modules/css-loader/index.js!./simcir-basicset.css", function() {
			var newContent = require("!!./node_modules/css-loader/index.js!./simcir-basicset.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./node_modules/css-loader/index.js!./simcir.css", function() {
			var newContent = require("!!./node_modules/css-loader/index.js!./simcir.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var simcir=__webpack_require__(15)
...
simcir.registerDevice('HalfAdder',
{
  ...
  "devices":[
    ...
    {"type":"EOR","id":"dev3","x":192,"y":32,"label":"XOR"},
    {"type":"In","id":"dev4","x":144,"y":32,"label":"A"},
    {"type":"In","id":"dev5","x":144,"y":80,"label":"B"},
    {"type":"Out","id":"dev6","x":240,"y":32,"label":"Y"},
    {"type":"Out","id":"dev7","x":240,"y":80,"label":"CY"},
...
var simcir = __webpack_require__(15);
//var simcirBasicSet = require('./simcir-basic-1.js');
var simcirBasicSet = __webpack_require__(65);
var simcirLibrary = __webpack_require__(66);
